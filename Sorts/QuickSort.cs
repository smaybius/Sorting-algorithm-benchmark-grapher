...
namespace Sorting_algorithm_benchmark_grapher.Sorts
{
    internal class QuickSort : ISorter
    {
        ...
        private int LomutoPartition<T>(T[] a, int p, int r, IComparer<T> cmp)
        {
        ...
        private int partition<T>(T[] array, int lo, int hi, IComparer<T> cmp)
        {
            ...
            {
                case 0:
                    return LomutoPartition(array, lo, hi, cmp);
                case 1:
                    return HoarePartition(array, lo, hi, cmp);
                case 2:
                    return ModifiedLomuto(array, lo, hi, cmp);
                case 3:
                    return ModifiedHoare(array, lo, hi, cmp);
                default:
                    return HoarePartition(array, lo, hi, cmp);
            }
        }
